...
import instructions.GetTc;
import instructions.Noop;
import instructions.IType.Beq;
import instructions.IType.Bgtz;
import instructions.IType.Bltz;
import instructions.IType.Bne;
import instructions.IType.LW;
import instructions.IType.SW;
import instructions.JType.Jump;
import instructions.Rtype.Add;
import instructions.Rtype.Div;
import instructions.Rtype.JumpRegister;
import instructions.Rtype.Mult;
import instructions.Rtype.Subtract;
...
public class Compile {
    ...
    public void fetch() {
        try (BufferedReader br = new BufferedReader(new FileReader("D:\\SimuladoPipeline\\SimuladorPipeline\\src\\input.txt"))) {
            String line;
